...
#         ], 1)
        ...
        d5 = self.decoder5(torch.cat([c, e5], 1))  # ; print('d5',f.size())
        ...
        empty_pro = self.logit_image(empty_pro)
        empty_pro_reshape = empty_pro.view(*empty_pro.size(),1,1)
        logitNew = self.logitNew(f)
        return logitNew*empty_pro_reshape,empty_pro
